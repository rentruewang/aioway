...
from aioway.relalg import LoaderExec, LoaderOpt
...
@pytest.fixture
def table_stream(block_table: TdictFrame, batch_size: int) -> LoaderExec:
...
@pytest.fixture
def concat_stream(concat_frame: TdictFrame, batch_size: int) -> LoaderExec:
...
@pytest.fixture
def joinable_stream(joinable_frame: TdictFrame, batch_size: int) -> LoaderExec:
