...
from aioway.nets import deduction_for, deduction_reg, with_nn_reg
...
def test_linear_deduct():
    from aioway.nets.deductions.dense import linear_deduct
...
def test_sequential_deduct():
    from aioway.nets.deductions.containers import sequential_deduct
...
def test_mse_deduct():
    from aioway.nets.deductions.losses import symmetric_loss_deduct
