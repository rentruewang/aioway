...
# %%
from aioway.tensors import PrintTorchDisp, PrintTorchFunc, mode_off
...
# %%
with PrintTorchDisp().activate(), PrintTorchFunc().activate(), mode_off():
    c = a + b
...
# %%
with PrintTorchDisp().activate(), mode_off(), PrintTorchFunc().activate():
    c = a + b
